...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Aquaint/AWSCloudWatch.framework"
  ...
  install_framework "Pods-Aquaint/AWSElasticLoadBalancing.framework"
  install_framework "Pods-Aquaint/AWSKinesis.framework"
  install_framework "Pods-Aquaint/AWSLambda.framework"
  install_framework "Pods-Aquaint/AWSMachineLearning.framework"
  install_framework "Pods-Aquaint/AWSMobileAnalytics.framework"
  install_framework "Pods-Aquaint/AWSS3.framework"
  install_framework "Pods-Aquaint/AWSSES.framework"
